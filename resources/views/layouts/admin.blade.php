...
<body class="flex min-h-screen flex-col bg-blue-100 font-sans antialiased lg:flex-row">
    <div x-data="{ open: false }">
        ...
        {{-- navigation --}}
        <nav :class="{ '-left-full': !open }" class="group fixed top-0 left-0 flex h-screen w-64 flex-grow-0 transform flex-col items-start justify-between overflow-hidden border-r border-gray-100 bg-white transition-all duration-300 lg:relative lg:!left-0 lg:w-20 hover:lg:!w-60">
            {{-- top menu items --}}
            <div>
